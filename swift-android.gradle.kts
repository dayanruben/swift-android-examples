...
data class SwiftConfig(
    ...
    var swiftVersion: String = "6.3-DEVELOPMENT-SNAPSHOT-2026-03-05", // Swift version
    var androidSdkVersion: String = "swift-6.3-DEVELOPMENT-SNAPSHOT-2026-03-05-a_android" // SDK version
)
